...
@section('navmenu')
  ...
  <a href="{{ route('profiles.index') }}">Profiles</a> <i class="fa fa-caret-right fa fw" style="color: #3c8dbc;"></i>
          ...
          <div class="tab-pane active" style="margin: 15px;">
            <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('profiles.update', $profile->id) }}" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input value="{{ $profile->fullname }}" name="fullname" type="text" class="form-control" id="inputName">
                </div>
              </div>
              <div class="form-group">
