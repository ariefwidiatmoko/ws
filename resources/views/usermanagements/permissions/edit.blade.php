...
@section('navmenu')
  ...
  <a href="{{ route('permissions.index') }}">Permission</a> <i class="fa fa-angle-right fa-fw" style="color: #3c8dbc;"></i>
  <a class="active" style="color: grey;">@yield('title')</a>
@endsection

@section('button')
  <a href="{{ route('permissions.index') }}" class="btn btn-xs btn-default"></i> Back</a>
@endsection
  ...
  <div class="box" style="margin-top: -20px;">
    ...
    <div class="box-body" style="margin-left: 15px; margin-right: 15px;">
      <form role="form" action="{{ route('permissions.update', $permission->id) }}" method="POST">
              {{ method_field('PUT') }}
              {{ csrf_field() }}
            @include('usermanagements.permissions._form_edit')
