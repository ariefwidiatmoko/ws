  ...
  <div class="fluid-container box box-solid">
    <div class="widget-user-header bg-aqua" style="padding-top:4px;padding-bottom:4px;padding-left:10px;">
      ...
      <a href="/article" style="color: white;">
        <h4 class="widget-user-username">Search Result</h4>
      </a>
    </div>
    @forelse ($result as $item)
      <div class="box box-widget">
        ...
        <div class="box-body">
          ...
          @endif
          <div class="col-md-8">
            <p style="margin-top: -7px;">{!! substr($item->content, 0, random_int(300, 320)) !!}... <a href="/article-news/{{strtolower($item->category->name)}}/{{$item->slug}}"><span class="badge bg-aqua">read more</span></a></p>
              <br>
