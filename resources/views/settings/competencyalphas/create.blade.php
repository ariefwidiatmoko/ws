...
@section('title', 'New Detail Score')
...
<div class="content" id="main-content" style="margin-top: -20px; margin-left: 1px;">
  ...
  <div class="box" style="margin-top: -20px;">
    ...
    <div class="box-body" style="margin-left: 15px; margin-right: 15px;">
      <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('details.store') }}" method="POST">
        {{ csrf_field() }}
        @include('settings.details._form_create')
