...
@section('navmenu')
  ...
  <a href="{{ route('grades.index') }}">Grades</a> <i class="fa fa-angle-right fa-fw" style="color: #3c8dbc;"></i>
...
<div class="content" id="main-content" style="margin-top: -20px; margin-left: 1px;">
  ...
  <div class="box" style="margin-top: -20px;">
    ...
    <div class="box-body" style="margin-left: 15px; margin-right: 15px;">
      <form enctype="multipart/form-data" role="form" action="{{ route('grades.store') }}" method="POST">
        {{ csrf_field() }}
        @include('settings.grades._form_create')
        <div class="">
          <!-- Submit Form Button -->
