...
@section('title', 'Edit Group Score')
...
@section('navmenu')
  ...
  <a href="{{ route('groups.index') }}">Type Scores</a> <i class="fa fa-caret-right fa fw" style="color: #3c8dbc;"></i>
...
<div class="content" id="main-content" style="margin-top: -20px; margin-left: 1px;">
  ...
  <div class="box" style="margin-top: -20px;">
    ...
    <div class="box-body" style="margin-left: 15px; margin-right: 15px;">
      <form enctype="multipart/form-data" class="form-horizontal" action="{{ route('groups.update', $group->id) }}" method="POST">
        {{ method_field('PUT') }}
        {{ csrf_field() }}
        @include('settings.groups._form_edit')
