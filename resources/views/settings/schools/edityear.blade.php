...
@section('title', 'Edit Year & Semester Active')
...
@section('navmenu')
  ...
  <a href="{{ route('schools.index') }}">School Profile</a> <i class="fa fa-caret-right fa fw" style="color: #3c8dbc;"></i>
...
<div class="content" id="main-content" style="margin-top: -20px; margin-left: 1px;">
  ...
  <div class="box" style="margin-top: -20px;">
    ...
    <div class="box-body" style="margin-left: 15px; margin-right: 15px;">
      <form enctype="multipart/form-data" role="form" action="{{ route('schools.updateYear', $yearactive->id) }}" method="POST">
        {{ method_field('PUT') }}
        {{ csrf_field() }}
      @include('settings.schools._form_edityear')
