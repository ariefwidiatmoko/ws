...
@section('navmenu')
  ...
  <a href="{{ route('notes.index') }}">Notes</a> <i class="fa fa-angle-right fa-fw" style="color: #3c8dbc;"></i>
  ...
  <div class="row" style="margin-top: -20px;">
    <div class="col-md-8">
      ...
      <div class="box-body" style="margin-left: 15px; margin-right: 15px;">
        <form enctype="multipart/form-data" role="form" action="{{ route('notes.update', $note->id) }}" method="POST">
          {{ method_field('PUT') }}
          {{ csrf_field() }}
        @include('contents.notes._form_edit')
          <div class="box-footer">
            <!-- Submit Form Button -->
            {!! Form::submit('Save', ['class' => 'btn btn-xs btn-success']) !!}
            <!-- Back Button -->
            <a href="{{ route('notes.index') }}" type="button" class="btn btn-default btn-xs">Cancel</a>
          </div>
        </form>
      </div>
      <!-- /.box-body -->
    ...
    <div class="col-md-4">
      <div class="box">
        <div class="box-body">
          <img src="/images/notes/{{ $note->image }}" class="img-responsive img-thumbnail" alt="Note's Image">
