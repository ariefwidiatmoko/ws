  ...
  <div class="text-right">
    <form action="#" method="GET">
      <div class="input-group input-group-sm col-md-12">
        <input type="text" name="search" class="form-control pull-right" placeholder="Search Scoringsheet...">
                ...
                <thead>
                  ...
                  <tbody>
                    @forelse ($result as $index => $item)
                      <tr class="clickable-row" data-href="{{route('scoringsheets.showscore', [3, $item->csbatch_id])}}">
                    ...
                    @empty
                      <tr>
                        <td colspan="8">No Scoringsheet</td>
                      </tr>
                    @endforelse
                  </tbody>
                </table>
